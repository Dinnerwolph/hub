...
public class GuiMain extends AbstractGui {
    ...
    public void display(Player player) {
        ...
        if (EuphalysApi.getInstance().getPlayer(player.getUniqueId()).getGroup().getGroupId() >= 50)
            this.setSlotData(ChatColor.BLUE + "Shattered Space", Material.DIAMOND_SWORD, 10, makeButtonLore(new String[]{"", "§8Cliquez pour rejoindre une partie", "", "Développeur: Dinnerwolph"}, true, false), "shattered");
        this.setBackSlot();
